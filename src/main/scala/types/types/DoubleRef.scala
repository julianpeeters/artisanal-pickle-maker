...
case class TypeRefTpe_Double(currentPosition: Position, thisTpe_scala: ThisTpe_scala, scala: ExtModClassRef_scala) extends Tpe {
  var position = 0
  ...
  def write(myPickleBuffer: PickleBuffer) = {
    ...
    TypeName(currentPosition, "Double").write(myPickleBuffer)
  }
}
