...
class AllDatatypesSpec extends mutable.Specification {
  ...
  "a ScalaSig for a case class with all supported datatypes (MyRecord_AllDatatypes) " should {
    "have the correct string" in {
      ...
      val mySig = new artisanal.pickle.maker.ScalaSig(List("case class"), List("models", "MyRecord_AllDatatypes"), List(("a", "Byte"), ("b", "Short"), ("c", "Int"), ("d", "Long"), ("e", "Float"), ("f", "Double"), ("g", "Char"), ("h", "String"), ("i", "Boolean"), ("j", "Unit"), ("k", "Null"), ("l", "Nothing"), ("m", "Any"), ("n", "Byte"), ("o", "Object")))
