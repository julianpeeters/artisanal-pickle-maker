...
class IteratorIteratorIteratorIteratorSpec extends mutable.Specification {
/*
  val mySig = new ScalaSig(List("case class"), List("models", "MyRecord_IteratorIterator"), List(("b", "Iterator"), ("", "Iterator")))
  val correctSig: String = {
    val scalaSigAnnot = classOf[MyRecord_IteratorIterator].getAnnotation(classOf[scala.reflect.ScalaSignature])
