...
##Usage:##
Available for Scala 2.11 (see branches for other supported versions). [![Build Status](https://travis-ci.org/julianpeeters/artisanal-pickle-maker.svg?branch=master)](https://travis-ci.org/julianpeeters/artisanal-pickle-maker)
